    ...
    public partial class Quanliphongban : Form
    {
        ...
        private void bt_timkiem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string query = "select MaPB N'Mã phòng ban',TenPB N'Tên phòng ban',SDT N'Số điện thoại',Diachi N'Địa chỉ' from dbo.PhongBan where active=1 and TenPB like N'%" + tb_timkiem.Text + "%' or MaPB like '%" + tb_timkiem.Text + "%'";
